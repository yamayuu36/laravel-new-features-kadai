...
<div class="row">
    ...
    <div class="col-9">
        ...
        <div>
            ...
            <?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('price', '価格'));?>
            <?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('reviews_avg_score', '評価'));?>
        </div>
                            ...
                            <p class="samuraimart-product-label mt-2 mb-0">
                                ...
                                <div class="average-score mb-1">
                                    <div class="star-rating ">
                                        <?php
                                        $score_avg = $product->reviews->avg('score');
